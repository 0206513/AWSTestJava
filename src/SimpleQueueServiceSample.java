 ...
 * (linux: ~/.aws/credentials or windows : %HOMEPATH%/.aws/credentials) 
...
public class SimpleQueueServiceSample {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			String myQueueUrl = "http://sqs.us-west-2.amazonaws.com/408096535527/lodgingqueue_sqs";
...
//			 System.out.println();
			...
			// Send a message
			System.out.println("Sending a message to lodgingqueue_sqs.\n");
			sqs.sendMessage(new SendMessageRequest(myQueueUrl,
					"This is my message text."));

			// Receive messages
			System.out.println("Receiving messages from lodgingqueue_sqs.\n");
